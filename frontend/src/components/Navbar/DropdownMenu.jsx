...
function DropdownMenu() {
  ...
  return (
    <li className="nav-item dropdown">
      <div className="nav-link dropdown-toggle cursor-pointer" onClick={handleClick}>
        <Avatar alt={username} className="user-pic" src={image} />
        {username}
      </div>

      <div className="dropdown-menu" style={{ display: dropdown ? 'block' : 'none' }} onMouseLeave={handleClick}>
        <DropdownItem icon="ion-person" text="Profile" url={`/profile/${username}`} state={loggedUser} />
