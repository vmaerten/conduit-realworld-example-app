...
function AuthorInfo() {
  ...
  const [{ bio, followersCount, following, image }, setAuthor] = useState(state || {})
  ...
  return (
    <div className="col-xs-12 col-md-10 offset-md-1">
      ...
      {username === loggedUser.username ? (
        ...
        <FollowButton followersCount={followersCount} following={following} handler={followHandler} username={username} />
      )}
    </div>
  )
}
