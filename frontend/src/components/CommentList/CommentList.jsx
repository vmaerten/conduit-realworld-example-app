...
function CommentList({ triggerUpdate, updateComments }) {
  ...
  const handleClick = (commentId) => {
    ...
    deleteComment({ commentId, headers, slug }).then(updateComments).catch(console.error)
  }
        ...
        <div className="card" key={id}>
          ...
          <div className="card-footer">
            ...
            {isAuth && loggedUser.username === username && (
              <button className="btn btn-sm btn-outline-secondary pull-xs-right" onClick={() => handleClick(id)}>
